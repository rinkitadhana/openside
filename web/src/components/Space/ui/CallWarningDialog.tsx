        ...
        <div className="flex justify-end gap-2">
          {onCancel && (
            <button
              type="button"
              onClick={onCancel}
              className="rounded-lg border border-border bg-primary px-3.5 py-2 text-sm font-medium text-foreground transition-colors hover:bg-primary"
            >
              {cancelLabel}
            </button>
          )}
          <button
            ...
            className={
              confirmVariant === "danger"
                ...
                : "rounded-lg border border-border bg-primary px-3.5 py-2 text-sm font-semibold text-primary-text transition-colors hover:bg-primary/85"
            }
          >
            {confirmLabel}
          </button>
