  ...
  if (!clerkPublishableKey) {
    return (
      <div className="min-h-screen w-full bg-background text-foreground flex items-center justify-center p-6">
        <div className="max-w-2xl w-full border border-border rounded-xl p-6 bg-secondary">
          ...
          <pre className="text-xs bg-primary border border-border rounded-lg p-3 overflow-auto">
