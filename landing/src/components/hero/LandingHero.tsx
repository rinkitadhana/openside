    ...
    <LayoutWrapper>
      <section className=" border-x border-primary-border p-4">
        <div className="h-[700px] flex items-center shadow-md shadow-primary-shadow justify-center border border-secondary-border rounded-xl mt-20 bg-[url('/img/hero.png')] dark:bg-[url('/img/hero-dark.png')] bg-cover bg-center">
          <div className="flex-1 w-full h-full flex flex-col gap-4 items-start justify-center p-10">
            <RecordingBadge />
            <h1 className="text-[4rem] font-[650] leading-[1.07]">
              From Video Call to Podcast in Minutes
            </h1>
            <p className="text-secondary-text">
              Asap is an AI powered video calling app with built in local
              recording, designed for podcasts, content creation, and more.
            </p>
            <div className="flex flex-col gap-4 w-full mt-4 pr-20 justify-start items-start">
              <Link
                href="/login"
              ...
              <p className="text-secondary-text w-full font-medium text-center text-xs">
